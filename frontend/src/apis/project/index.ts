...
export const loadData = (param: PageReq) => alovaInstance.Post<IPage<IProject[]>>(`/system/project/page`, param)
export const loadProjectList = () => alovaInstance.Get<IProject[]>(`/system/project/list`)
/**
 * 查询项目数据
 ...
 * @returns
 */
export const saveData = (param: IProject) => alovaInstance.Post<IProject>("/system/project/save", param)
/**
 * edit project
 * @param param project
 * @returns
 */
export const updateData = (param: IProject) => alovaInstance.Put(`/system/project/update`, param)
/**
